...
After SW1 receives the frame, it will broadcast it out all of its interface except the so that means G0/1 and G0/2. SW2 will then do the same with the frame, broadcasting it [3:27]
